...
type Exercise = "sitUps" | "run" | "pushUps" | "pullUps" | "swim";

type Scores = {
  [E in Exercise]: ExerciseScores;
};
...
const scores: Scores = {
  sitUps: {
    ...
    QOS: {
      Masculino: [
        { min: 60, max: Infinity, score: 10.0 },
        { min: 56, max: 59, score: 9.5 },
        { min: 51, max: 55, score: 9.0 },
        { min: 46, max: 50, score: 8.5 },
        { min: 41, max: 45, score: 8.0 },
        { min: 36, max: 40, score: 7.5 },
        { min: 31, max: 35, score: 7.0 },
        { min: 26, max: 30, score: 6.5 },
        { min: 21, max: 25, score: 6.0 },
        { min: 20, max: 20, score: 5.0 },
        { min: 16, max: 19, score: 4.0 },
        { min: 12, max: 15, score: 3.0 },
        { min: 8, max: 11, score: 2.0 },
        { min: 4, max: 7, score: 1.0 },
        { min: 0, max: 3, score: 0.0 },
      ],
      Feminino: [
        { min: 55, max: Infinity, score: 10.0 },
        { min: 51, max: 54, score: 9.5 },
        { min: 46, max: 50, score: 9.0 },
        { min: 41, max: 45, score: 8.5 },
        { min: 36, max: 40, score: 8.0 },
        { min: 31, max: 35, score: 7.5 },
        { min: 26, max: 30, score: 7.0 },
        { min: 21, max: 25, score: 6.5 },
        { min: 16, max: 20, score: 6.0 },
        { min: 15, max: 15, score: 5.0 },
        { min: 11, max: 14, score: 4.0 },
        { min: 7, max: 10, score: 3.0 },
        { min: 3, max: 6, score: 2.0 },
        { min: 1, max: 2, score: 1.0 },
  ...
  run: {
    ...
    QOS: {
      ...
      Feminino: [
        { min: 2800, max: Infinity, score: 10.0 },
        { min: 2700, max: 2799, score: 9.5 },
        { min: 2600, max: 2699, score: 9.0 },
        { min: 2500, max: 2599, score: 8.5 },
        { min: 2400, max: 2499, score: 8.0 },
        { min: 2300, max: 2399, score: 7.5 },
        { min: 2200, max: 2299, score: 7.0 },
        { min: 2100, max: 2199, score: 6.5 },
        { min: 2000, max: 2099, score: 6.0 },
        { min: 1900, max: 1999, score: 5.0 },
        { min: 1800, max: 1899, score: 4.0 },
        { min: 1700, max: 1799, score: 3.0 },
        { min: 1600, max: 1699, score: 2.0 },
        { min: 1500, max: 1599, score: 1.0 },
        { min: 0, max: 1499, score: 0.0 },
      ],
    },
  },
  pushUps: {
    ...
    QOS: {
      Masculino: [
        { min: 35, max: Infinity, score: 10.0 },
        { min: 33, max: 34, score: 9.5 },
        { min: 30, max: 32, score: 9.0 },
        { min: 27, max: 29, score: 8.5 },
        { min: 24, max: 26, score: 8.0 },
        { min: 21, max: 23, score: 7.5 },
        { min: 18, max: 20, score: 7.0 },
        { min: 15, max: 17, score: 6.5 },
        { min: 13, max: 14, score: 6.0 },
        { min: 12, max: 12, score: 5.0 },
        { min: 8, max: 11, score: 4.0 },
        { min: 5, max: 7, score: 3.0 },
        { min: 3, max: 4, score: 2.0 },
        { min: 1, max: 2, score: 1.0 },
        { min: 0, max: 0, score: 0.0 },
      ],
      Feminino: [
  ...
  pullUps: {
    QOC: {
      Masculino: [
        { min: 15, max: Infinity, score: 10.0 },
    ...
    QOS: {
      Masculino: [
        { min: 12, max: Infinity, score: 10.0 },
        { min: 11, max: 11, score: 9.5 },
        { min: 9, max: 10, score: 9.0 },
        { min: 8, max: 8, score: 8.5 },
        { min: 7, max: 7, score: 8.0 },
        { min: 6, max: 6, score: 7.5 },
        { min: 4, max: 5, score: 7.0 },
        { min: 3, max: 3, score: 6.5 },
        { min: 2, max: 2, score: 6.0 },
        { min: 1, max: 1, score: 5.0 },
        { min: 0, max: 0, score: 0.0 },
      ],
      Feminino: [
        { min: 45, max: Infinity, score: 10.0 },
        { min: 41, max: 44, score: 9.5 },
        { min: 35, max: 40, score: 9.0 },
        { min: 31, max: 34, score: 8.5 },
        { min: 27, max: 30, score: 8.0 },
        { min: 23, max: 26, score: 7.5 },
        { min: 19, max: 22, score: 7.0 },
        { min: 15, max: 18, score: 6.5 },
        { min: 11, max: 14, score: 6.0 },
        { min: 5, max: 10, score: 5.0 },
        { min: 3, max: 4, score: 4.0 },
        { min: 1, max: 2, score: 2.0 },
        { min: 0, max: 0, score: 0.0 },
      ],
    },
  },
  swim: {
    ...
    QOS: {
      Masculino: [
        { min: 0, max: 16, score: 10.0 },
        { min: 17, max: 17, score: 9.5 },
        { min: 18, max: 19, score: 9.0 },
        { min: 20, max: 22, score: 8.5 },
        { min: 23, max: 25, score: 8.0 },
        { min: 26, max: 30, score: 7.5 },
        { min: 31, max: 35, score: 7.0 },
        { min: 36, max: 40, score: 6.5 },
        { min: 41, max: 44, score: 6.0 },
        { min: 45, max: 50, score: 5.0 },
        { min: 51, max: 55, score: 4.0 },
        { min: 56, max: 60, score: 2.0 },
        { min: 61, max: Infinity, score: 0.0 },
      ],
      Feminino: [
        { min: 0, max: 21, score: 10.0 },
        { min: 22, max: 22, score: 9.5 },
        { min: 23, max: 24, score: 9.0 },
        { min: 25, max: 27, score: 8.5 },
        { min: 28, max: 30, score: 8.0 },
        { min: 31, max: 35, score: 7.5 },
        { min: 36, max: 40, score: 7.0 },
        { min: 41, max: 45, score: 6.5 },
        { min: 46, max: 49, score: 6.0 },
        { min: 50, max: 55, score: 5.0 },
        { min: 56, max: 60, score: 4.0 },
        { min: 61, max: 65, score: 2.0 },
        { min: 66, max: Infinity, score: 0.0 },
      ],
    },
  },
};
...
export function getScore({
  ...
  exercise,
  category,
}: GetScoreParams): number {
  const ranges = scores[exercise][category][gender];
